...
function LoginPage() {
  ...
  const googleOAuth2Url = import.meta.env.VITE_REACT_APP_GOOGLE_OAUTH2_URL;
          ...
          <div className="hidden md:flex md:col-span-2 flex-col justify-center p-8 bg-blue-600 text-white rounded-l-2xl">
            <div className="space-y-6">
              ...
              <p className="text-lg opacity-90">
                Đăng nhập để kết nối với chúng tôi và nhận sự hỗ trợ bạn cần.
              </p>
              ...
              >
                ...
                <div className="mt-4 text-center">
                  <a
                    ...
                    className="inline-flex items-center justify-center px-6 py-3 bg-white border border-gray-300 rounded-lg shadow hover:bg-gray-50 transition text-gray-700 font-semibold"
                    style={{ minWidth: 220 }}
                  >
                    <img
