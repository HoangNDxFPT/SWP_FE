...
function AssistAssessment() {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        setLoading(true);
        console.log('Đang gọi API với loại đánh giá: ASSIST');
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <div className="bg-red-50 rounded-lg p-6 inline-block">
            ...
            <p className="text-red-800 font-medium mb-2">Không có câu hỏi ASSIST nào.</p>
            <button 
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="mb-8 bg-white rounded-lg shadow-sm border border-gray-200 p-5">
            ...
            <p className="text-sm text-gray-600 mt-3">
              Tùy thuộc vào mức độ rủi ro, bạn có thể được khuyến nghị theo dõi thêm hoặc tham gia các khóa học phòng ngừa.
            </p>
          </div>
