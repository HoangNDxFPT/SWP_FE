...
function AssessmentResult() {
  ...
  useEffect(() => {
    ...
    if (assessmentResultId) {
      ...
      setLoading(false);
      toast.error('ID kết quả đánh giá không hợp lệ!');
      navigate('/assessment');
    }
    ...
    switch (riskLevel) {
      ...
      case 'HIGH':
        return {
          ...
          icon: (
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a4 4 0 118 0v4m-4 8a2 2 0 100-4 2 2 0 000 4zm6 3a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
          ),
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">Đang tải kết quả đánh giá</h2>
              <p className="text-gray-600 mb-2">Vui lòng đợi trong giây lát</p>
              <p className="text-sm text-gray-500">Hệ thống đang phân tích và tổng hợp kết quả cho bạn</p>
            </div>
          </div>
        </div>
        <Footer />
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-red-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">Không tìm thấy kết quả đánh giá</h2>
              <p className="text-gray-600 mb-6">Có thể ID kết quả không hợp lệ hoặc kết quả đã bị xóa.</p>
            ...
            <div className="border-b border-gray-200">
              <nav className="flex">
                <button
                  ...
                  className={`flex-1 py-4 px-6 font-medium text-center relative transition-all duration-200 ${
                    activeTab === 'summary' 
                ...
                {(hasSubstanceResults || hasAnswers) && (
                  <button
          ...
          {activeTab === 'summary' && (
            <div className="animate-fadeIn">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
                ...
                <div className={`p-4 rounded-lg ${riskInfo.bgColor} mb-4`}>
                  <p className={`mb-4 ${riskInfo.textDark}`}>Mức độ đánh giá của bạn dựa trên chất có điểm số cao nhất. Hãy tham khảo các khuyến nghị bên dưới để cải thiện kết quả của bạn.</p>
                </div>
